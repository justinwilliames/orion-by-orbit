...
extension TerminalView {
    func presentAttachmentPicker() {
        ...
        panel.message = "Choose files you want Orbit to use in the answer — images, PDFs, spreadsheets, notes, or code. You can also drag them in or paste from the clipboard."
